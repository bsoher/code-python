How To Document Your ... Algorithm Code
---------------------------------------

The algos directory is for shared code that provides working algorithms.
We're running pretty loose with a definition for 'algorithm' but would
prefer that this code have more to do with 'science' than with 'coding'
generally. 
